...
const allProfilingArticles = [
  ...
  {
    id: 6,
    title: "Band Underground Surabaya: Ekspresi Tanpa Batas",
    excerpt: "Profil lengkap scene musik underground di Surabaya dan band-band yang menggerakkannya.",
    category: "musik",
    date: "20 Jan 2026",
    readTime: "6 menit",
...
// Inject ad after every N articles
const AD_EVERY_N = 3;
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {allProfilingArticles.map((post, i) => (
              <div key={post.id}>
                ...
                {/* Inject banner ad every N articles */}
