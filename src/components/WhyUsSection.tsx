...
const reasons = [
  {
    icon: Lightbulb,
    title: "Strategic & Creative-Driven",
    description: "Every project starts with deep research and creative thinking to deliver meaningful results.",
  },
  {
    icon: Boxes,
    title: "Web3-Ready Digital Mindset",
    description: "We stay ahead with cutting-edge Web3 technologies and decentralized approaches.",
  },
  {
    icon: TrendingUp,
    title: "Scalable Growth Solutions",
    description: "Our solutions are built to scale with your business, from startup to enterprise.",
  },
  {
    icon: Handshake,
    title: "Long-Term Digital Partnership",
    description: "We're not just vendors — we're partners invested in your long-term digital success.",
  },
];
