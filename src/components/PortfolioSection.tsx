...
const projects = [
  {
    ...
    metric: "+180% User Engagement",
    gradient: "from-electric/80 to-navy",
  },
  {
    title: "NeoVerse Branding",
    category: "Branding & Identity",
    metric: "50K+ Social Impressions",
    gradient: "from-navy to-electric/60",
  },
  {
    title: "CryptoLaunch Campaign",
    category: "Digital Campaign",
    metric: "3x Conversion Rate",
    gradient: "from-electric/60 to-navy/90",
  },
  {
    title: "MetaStudio Platform",
    category: "System Development",
    metric: "99.9% Uptime",
    gradient: "from-navy/80 to-electric",
  },
  {
    title: "BlockBrand Content",
    category: "Content Production",
    metric: "1M+ Video Views",
    gradient: "from-electric to-navy/70",
  },
  {
    title: "ChainSocial Growth",
    category: "Social Media",
    metric: "+400% Followers",
    gradient: "from-navy to-electric/70",
  },
];
          ...
          {projects.map((project, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-6 text-primary-foreground opacity-0 group-hover:opacity-100 translate-y-4 group-hover:translate-y-0 transition-all duration-500">
                <span className="text-xs font-semibold uppercase tracking-wider text-electric-light mb-1">
                  {project.category}
                </span>
